...
angular.module('app').constant('SERVER', {
  ...
  api: (DEVELOP ? 'http://gpsapi04.navi.cc:8982/' : 'http://api.newgps.navi.cc/') + API_VERSION,
  ...
  channel: DEVELOP ? 'ws://gpsapi04.navi.cc:8983/websocket' : 'http://channel.newgps.navi.cc:8888/socket'
});
